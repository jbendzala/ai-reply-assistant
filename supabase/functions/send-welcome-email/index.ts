      ...
      <table width="100%" style="max-width:520px;background:#13131A;border-radius:16px;overflow:hidden;border:1px solid #2A2A3D;" cellpadding="0" cellspacing="0" role="presentation">
        ...
        <tr><td style="padding:40px 40px 32px;text-align:center;">
          <div style="display:inline-block;margin-bottom:24px;">
            <div style="width:72px;height:72px;border-radius:16px;background:#1A2B4B;border:2px solid #4F8EF7;display:inline-flex;align-items:center;justify-content:center;font-size:24px;font-weight:800;color:#4F8EF7;font-family:Arial,Helvetica,sans-serif;line-height:72px;text-align:center;">AR</div>
          </div>
